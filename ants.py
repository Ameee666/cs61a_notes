...
class Ant(Insect):
    ...
    def double(self):
        ...
        # BEGIN Problem 12
        "*** YOUR CODE HERE ***"
        if self.whether_doubled == False:
            self.damage *= 2
            self.whether_doubled = True
        # END Problem 12
...
class HarvesterAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        gamestate.food+=1       # END Problem 1
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while move <= self.upper_bound :    
            if not current.entrance:
                return None
                break
...
class ShortThrower(ThrowerAnt):
    ...
    implemented = True
    upper_bound = 3
    lower_bound = 0   # Change to True to view in the GUI
    # END Problem 4
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        if will_die:
            new_new_bees = self.place.bees[:]
            for bee in new_new_bees:
